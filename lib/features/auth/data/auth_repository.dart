...
class AuthRepository {
  ...
  /// fresh session. `deviceId` is required by the contract — it's the single
  /// enforcement point for device binding.
  ...
  Future<void> logout({required String accessTokenHeader}) =>
      _api.logout(accessTokenHeader: accessTokenHeader);
}
